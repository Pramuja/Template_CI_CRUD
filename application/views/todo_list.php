...
<html lang="en">
  ...
  <section id="container" >
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="<?=base_url()?>todo_list.html">Todo List</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="<?=base_url()?>javascript:;" >
      ...
      *********************************************************************************************************************************************************** -->
				              ...
				              <tbody>
				                <tr>
				           			<td>
				                        ...
				                        <a href="<?=base_url()?>index.html#">Send invoice</a></span>
				                ...
				                <tr>
				           			<td>
				                        <span class="check"><input type="checkbox" class="checked"></span>
				                        <a href="<?=base_url()?>index.html#">Check messages</a></span>
				                        <button class="close" aria-hidden="true" data-dismiss="alert" type="button">×</button>
									</td>
				                </tr>
				                <tr>
				            		<td>
				                        <span class="check"><input type="checkbox" class="checked"></span>
				                        <a href="<?=base_url()?>index.html#">Pay bills</a></span>
				                        <button class="close" aria-hidden="true" data-dismiss="alert" type="button">×</button>
									</td>
				                </tr>
				                <tr>
				            		<td>
				                        <span class="check"><input type="checkbox" class="checked"></span>
				                        <a href="<?=base_url()?>index.html#">Schedule site </a></span>
				                        <button class="close" aria-hidden="true" data-dismiss="alert" type="button">×</button>
									</td>
				                 </tr>
				              </tbody>
	                	...
	                	<div class="panel-heading">
                          ...
                          <div class="panel-body">
                              ...
                              <div class=" add-task-row">
                                  <a class="btn btn-success btn-sm pull-left" href="<?=base_url()?>todo_list.html#">Add New Tasks</a>
                                  <a class="btn btn-default btn-sm pull-right" href="<?=base_url()?>todo_list.html#">See All Tasks</a>
                              </div>
                          </div>
                      </section>
                  </div><!-- /col-md-12-->
      ...
      <footer class="site-footer">
          <div class="text-center">
              2014 - Alvarez.is
              <a href="<?=base_url()?>todo_list.html#" class="go-top">
	...
	<script src="<?=base_url()?>http://code.jquery.com/ui/1.10.3/jquery-ui.js"></script>    
    <script src="<?=base_url()?>assets/js/tasks.js" type="text/javascript"></script>
