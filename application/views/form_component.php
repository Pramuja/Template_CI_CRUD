...
<html lang="en">
  ...
  <section id="container" >
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li class="active"><a  href="<?=base_url()?>form_component.html">Form Components</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="<?=base_url()?>javascript:;" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <footer class="site-footer">
          <div class="text-center">
              2014 - Alvarez.is
              <a href="<?=base_url()?>form_component.html#" class="go-top">
	...
	<script type="text/javascript" src="<?=base_url()?>assets/js/bootstrap-daterangepicker/date.js"></script>
