          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li class="active"><a  href="<?=base_url()?>general.html">General</a></li>
      ...
      *********************************************************************************************************************************************************** -->
      			...
      			<div class="col-lg-6 col-md-6 col-sm-12">
      				...
      				<div class="showback">
      					<h4><i class="fa fa-angle-right"></i> Gritter Examples</h4>
							...
							<a id="add-regular" class="btn btn-default btn-sm" href="<?=base_url()?>javascript:;">Regular</a>
							<a id="add-sticky" class="btn btn-success  btn-sm" href="<?=base_url()?>javascript:;">Sticky</a>
							<a id="add-without-image" class="btn btn-info  btn-sm" href="<?=base_url()?>javascript:;">Imageless</a>
							<a id="add-gritter-light" class="btn btn-warning  btn-sm" href="<?=base_url()?>javascript:;">Light</a>
							<a id="remove-all" class="btn btn-danger  btn-sm" href="<?=base_url()?>general.html#">Remove all</a>
      				</div><!-- /showback -->
      ...
      <footer class="site-footer">
          <div class="text-center">
              2014 - Alvarez.is
              <a href="<?=base_url()?>general.html#" class="go-top">
