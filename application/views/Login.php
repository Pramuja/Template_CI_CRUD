      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  	<div class="container">
			  ...
			  ?>
		      <form method="POST" class="form-login" action="<?=base_url();?>index.php/user/Login">
		        ...
		        <div class="login-wrap">
		            ...
		            <label class="checkbox">
		                <span class="pull-right">
		                    <a data-toggle="modal" href="<?=base_url()?>index.php/user/login"> Forgot Password?</a>
		
		                </span>
		            </label>
		            <button class="btn btn-theme btn-block" href="<?=base_url()?>" type="submit"><i class="fa fa-lock"></i> SIGN IN</button>
		            <hr>
