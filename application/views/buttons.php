              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="<?=base_url()?>buttons.html">Buttons</a></li>
      ...
      *********************************************************************************************************************************************************** -->
						...
						<div class="btn-group">
						  ...
						  <div class="btn-group">
						    ...
						    <ul class="dropdown-menu">
						      <li><a href="<?=base_url()?>#">Dropdown link</a></li>
						      <li><a href="<?=base_url()?>#">Dropdown link</a></li>
						    </ul>
						  </div>
						</div>      					
      				...
      				<div class="showback">
						...
						<div class="btn-group">
						  ...
						  <ul class="dropdown-menu" role="menu">
						    <li><a href="<?=base_url()?>#">Action</a></li>
      ...
      <footer class="site-footer">
          <div class="text-center">
              2014 - Alvarez.is
              <a href="<?=base_url()?>buttons.html#" class="go-top">
