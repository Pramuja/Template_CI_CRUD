              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="<?=base_url()?>panels.html">Panels</a></li>
                      </ul>
                  </li>
      ...
      *********************************************************************************************************************************************************** -->
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-4 col-sm-4 mb">
							...
							<div class="white-panel pn">
								...
								<p><img src="<?=base_url()?>assets/img/ui-zac.jpg" class="img-circle" width="50"></p>
								<p><b>Zac Snider</b></p>
									<div class="row">
										<div class="col-md-6">
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-4 col-sm-4 mb">
							<div class="content-panel pn">
								<div id="profile-02">
									<div class="user">
										<img src="<?=base_url()?>assets/img/friends/fr-06.jpg" class="img-circle" width="80">
										<h4>DJ SHERMAN</h4>
									</div>
								</div>
								<div class="pr2-social centered">
									...
									<a href="<?=base_url()?>#"><i class="fa fa-dribbble"></i></a>
								</div>
							</div><! --/panel -->
						</div><!--/ col-md-4 -->
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-4 col-sm-4 mb">
							<div class="content-panel pn">
								...
								<div class="blog-text">
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. <a href="<?=base_url()?>#">Read More</a></p>
								</div>
							</div>
						</div><!-- /col-md-4-->
						...
						<div class="col-lg-4 col-md-4 col-sm-4 mb">
							<div class="weather-2 pn">
								...
								<div class="row centered">
									<img src="<?=base_url()?>assets/img/ny.jpg" class="img-circle" width="120">			
								</div>
								<div class="row data">
									<div class="col-sm-6 col-xs-6 goleft">
										<h4><b>16 ºC</b></h4>
      ...
      <footer class="site-footer">
          <div class="text-center">
              2014 - Alvarez.is
              <a href="<?=base_url()?>panels.html#" class="go-top">
